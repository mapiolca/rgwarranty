...
/**
 *       \file       htdocs/gestionnairerg/ajax/retainedwarranty.php
 *       \brief      File to return Ajax response on retainedwarranty list request
 */
...
// Security check
if (!$user->hasRight('gestionnairerg', 'retainedwarranty', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax gestionnairerg/ajax/retainedwarranty.php");
