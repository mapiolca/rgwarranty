...
/**
 *  \file       core/modules/gestionnairerg/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_retainedwarranty
 */
class pdf_standard_retainedwarranty extends ModelePDFRetainedWarranty
{
	/**
	 ...
	 *
	 *	@param	TCPDF|TCPDI	$pdf     		Object PDF
	 *	@param	RetainedWarranty	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('GESTIONNAIRERG_DRAFT_WATERMARK') && $object->status == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('GESTIONNAIRERG_DRAFT_WATERMARK')));
		}
